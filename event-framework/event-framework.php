...
require_once 'lib/eventbrite/autoload.php';
require_once 'lib/geocode.php';
require_once 'lib/simplexlsx.class.php';
...
class DX_Event_Framework {
    ...
    public function __construct() {
        ...
        add_filter('tiny_mce_before_init', array($this, 'dx_tiny_mce_before_init'));
    ...
    public function require_core() {
        ...
        include_once( EF_FIELDS_DIR . 'link.php' );
        ...
        include_once( EF_FIELDS_DIR . 'facebook-importer.php' );
        include_once( EF_FIELDS_DIR . 'eventbrite-importer.php' );
    ...
    function dx_tiny_mce_before_init($init) {
        $current_screen = null;
