...
function efcb_columns_4($atts, $content) {
    ...
    $content4 = EF_Framework_Helper::get_text_between_two_tags($content, '[content4]', '[/content4]');
    ...
    echo apply_filters('efcb_shortcode_render', '', 'efcb_columns_4', array(
        'content1' => $content1,
        'content2' => $content2,
        'content3' => $content3,
        'content4' => $content4,
...
// Register Shortcode
add_shortcode('efcb-section-columns-4', 'efcb_columns_4');
