...
if (!class_exists('EF_Content_Builder_Section_Event_Description')) {

    class EF_Content_Builder_Section_Event_Description extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'event-description';
            $this->clientID = 'efcb-section-event-description';
            $this->name = __('Event Description', 'dxef');
