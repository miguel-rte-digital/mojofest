...
if (!class_exists('EF_Content_Builder_Section_CallToAction_Small')) {

    class EF_Content_Builder_Section_CallToAction_Small extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'calltoaction-small';
            $this->clientID = 'efcb-section-calltoaction-small';
            $this->name = __('Small Call to Action', 'dxef');
            ...
            $this->options = array(
                ...
                array(
                    'ID' => 'link_hover_font_color',
                    'name' => __('Link hover text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
