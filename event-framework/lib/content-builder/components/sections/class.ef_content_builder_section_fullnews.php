...
if (!class_exists('EF_Content_Builder_Section_FullNews')) {

    class EF_Content_Builder_Section_FullNews extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'fullnews';
            $this->clientID = 'efcb-section-fullnews';
            $this->name = __('Full News', 'dxef');
            ...
            $this->options = array(
                ...
                array(
                    ...
                    'name' => __('News subtitle text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                ...
                array(
                    ...
                    'name' => __('News subtitle text size:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::TEXT,
                    'nested' => false
                ),
