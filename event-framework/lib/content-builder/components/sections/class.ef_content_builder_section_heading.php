...
if (!class_exists('EF_Content_Builder_Section_Heading')) {

    class EF_Content_Builder_Section_Heading extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'heading';
            $this->clientID = 'efcb-section-heading';
            $this->name = __('Heading', 'dxef');
            $this->cssClass = 'ef-cb-section';
            $this->iconCssClass = 'fa fa-font';
