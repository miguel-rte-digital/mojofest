...
if (!class_exists('EF_Content_Builder_Section_Instagram')) {

    class EF_Content_Builder_Section_Instagram extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'instagram';
            $this->clientID = 'efcb-section-instagram';
            $this->name = __('Instagram', 'dxef');
