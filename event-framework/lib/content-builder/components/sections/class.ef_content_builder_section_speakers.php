...
if (!class_exists('EF_Content_Builder_Section_Speakers')) {

    class EF_Content_Builder_Section_Speakers extends EF_Content_Builder_Section {
        ...
        function __construct() {
            ...
            $this->ID = 'speakers';
            $this->clientID = 'efcb-section-speakers';
            $this->name = sprintf(__('%s Showcase', 'dxef'), $ef_speaker_label_plural);
            ...
            $this->options = array(
                ...
                array(
                    'ID' => 'show_pagination',
                    'name' => __('Show load more button:', 'dxef'),
                    'desc' => '',
