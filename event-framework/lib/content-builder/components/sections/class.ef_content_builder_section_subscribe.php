...
if (!class_exists('EF_Content_Builder_Section_Subscribe')) {

    class EF_Content_Builder_Section_Subscribe extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'subscribe';
            $this->clientID = 'efcb-section-subscribe';
            $this->name = __('Subscribe', 'dxef');
            $this->cssClass = 'ef-cb-section';
            $this->iconCssClass = 'fa fa-envelope-o';
            ...
            $this->options = array(
                ...
                array(
                    ...
                    'name' => __('Subtitle font size:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::TEXT,
                    'nested' => false
                ),
