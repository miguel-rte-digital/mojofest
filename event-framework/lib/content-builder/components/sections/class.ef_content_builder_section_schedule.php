...
if (!class_exists('EF_Content_Builder_Section_Schedule')) {

    class EF_Content_Builder_Section_Schedule extends EF_Content_Builder_Section {

        function __construct() {
            $ef_speaker_label_singular = apply_filters('ef_post_type_label', __('Speaker', 'dxef'), 'speaker', 1);

            $this->ID = 'schedule';
            $this->clientID = 'efcb-section-schedule';
            $this->name = __('Schedule Showcase', 'dxef');
            ...
            $this->options = array(
                ...
                array(
                    'ID' => 'session_text_font_color',
                    'name' => __('Session text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                ...
                array(
                    'ID' => 'speaker_name_font_color',
                    'name' => sprintf(__('%s title color:', 'dxef'), $ef_speaker_label_singular),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                ...
                array(
                    'ID' => 'session_text_font_size',
                    'name' => __('Session text font size:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::TEXT,
                    'nested' => false
                ),
                ...
                array(
                    'ID' => 'speaker_name_font_size',
                    'name' => sprintf(__('%s title font size:', 'dxef'), $ef_speaker_label_singular),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::TEXT,
                    'nested' => false
                ),
