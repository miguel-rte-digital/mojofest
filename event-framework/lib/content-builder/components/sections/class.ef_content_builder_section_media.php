...
if (!class_exists('EF_Content_Builder_Section_Media')) {

    class EF_Content_Builder_Section_Media extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'media';
            $this->clientID = 'efcb-section-media';
            $this->name = __('Media', 'dxef');
            $this->cssClass = 'ef-cb-section';
            $this->iconCssClass = 'fa fa-th-list';
            $this->hasEntities = true;
            $this->entityType = 'post';
            $this->longView = 'section-media-long';
