...
if (!class_exists('EF_Content_Builder_Section_Twitter')) {

    class EF_Content_Builder_Section_Twitter extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'twitter';
            $this->clientID = 'efcb-section-twitter';
            $this->name = __('Twitter', 'dxef');
            $this->cssClass = 'ef-cb-section';
            $this->iconCssClass = 'fa fa-twitter';
            $this->hasEntities = false;
            $this->entityType = false;
            $this->description = __('Please insert Twitter API in the Theme Options page.', 'dxef');
            $this->options = array(
                array(
                    'ID' => 'title',
                    'name' => __('Title', 'dxef'),
                ...
                array(
                    ...
                    'name' => __('Tweet links color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
