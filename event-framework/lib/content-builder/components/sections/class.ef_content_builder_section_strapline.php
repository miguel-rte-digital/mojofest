...
if (!class_exists('EF_Content_Builder_Section_Strapline')) {

    class EF_Content_Builder_Section_Strapline extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'strapline';
            $this->clientID = 'efcb-section-strapline';
            $this->name = __('Strapline', 'dxef');
            $this->cssClass = 'ef-cb-section';
            $this->iconCssClass = 'fa fa-bold';
