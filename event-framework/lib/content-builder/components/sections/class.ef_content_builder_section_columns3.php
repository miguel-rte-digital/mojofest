...
if (!class_exists('EF_Content_Builder_Section_Columns3')) {

    class EF_Content_Builder_Section_Columns3 extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'columns-3';
            $this->clientID = 'efcb-section-columns-3';
            $this->name = __('Columns 3', 'dxef');
