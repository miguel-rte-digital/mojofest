...
if (!class_exists('EF_Content_Builder_Section_Columns2')) {

    class EF_Content_Builder_Section_Columns2 extends EF_Content_Builder_Section {

        function __construct() {
            $this->ID = 'columns-2';
            $this->clientID = 'efcb-section-columns-2';
            $this->name = __('Columns 2', 'dxef');
