...
if (!class_exists('EF_Content_Builder_Section_Schedule_Slider')) {

    class EF_Content_Builder_Section_Schedule_Slider extends EF_Content_Builder_Section {

        function __construct() {
            $ef_speaker_label_singular = apply_filters('ef_post_type_label', __('Speaker', 'dxef'), 'speaker', 1);

            $this->ID = 'schedule-slider';
            $this->clientID = 'efcb-section-schedule-slider';
            $this->name = __('Schedule Slider', 'dxef');
            ...
            $this->options = array(
                array(
                    'ID' => 'view_button_text',
                    'name' => __('"FULL SCHEDULE" button text', 'dxef'),
                    'desc' => '',
                ...
                array(
                    ...
                    'name' => __('Session "View" button text color:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::COLOR,
                    'nested' => false
                ),
                ...
                array(
                    ...
                    'name' => __('Session location font size:', 'dxef'),
                    'desc' => '',
                    'type' => EF_Content_Builder_Option_Type::TEXT,
                    'nested' => false
                ),
