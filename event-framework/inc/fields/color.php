...
class EF_Color_Field extends EF_Field_Base {
    ...
    public function display() {
        ...
        <section id="<?php echo $section_prefix . $this->id ?>" class="<?php echo $class ?>" <?php echo $style; ?>>
            ...
            <input id="<?php echo $this->id_prefix . $this->id ?>" type="text" name="eventframework[<?php echo $this->id ?>]" value="<?php if (!empty($this->value)) {
            echo $this->value;
        } else {
            echo $default;
        } ?>" placeholder="<?php echo $this->name; ?>" class="ef-picker" />
